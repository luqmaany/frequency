...
class _DeckSelectionScreenState extends ConsumerState<DeckSelectionScreen>
  ...
  Future<void> _loadOwnedDecks() async {
    ...
    setState(() {
      ...
      // Initialize selection with first 4 owned decks by default, unless initial selection is provided
      if (widget.initialSelectedDecks != null &&
          widget.initialSelectedDecks!.isNotEmpty) {
        _selectedDecks = Set.from(widget.initialSelectedDecks!);
      } else {
        _selectedDecks = Set.from(_ownedDecks.take(4));
      }
                        ...
                        children: [
                          ...
                          Expanded(
                            child: TeamColorButton(
                              ...
                              onPressed: _selectedDecks.isNotEmpty
                                  ? _deselectAll
                                  : null,
                            ),
                          ),
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      category.wordCount < 100
                          ? '<100 words'
                          : '${((category.wordCount / 100).ceil() * 100)}+ words',
